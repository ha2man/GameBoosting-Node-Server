...
const Form_reducer_reducer = (state = Form_reducer_initialState, action) => (0,immer_esm["default"])(state, (draftState) => {
  switch (action.type) {
...
const Form = (0,react.forwardRef)(({ projectSettingsStored }, ref) => {
  ...
  return /* @__PURE__ */ react.createElement(
    ...
    /* @__PURE__ */ react.createElement(Grid/* Grid */.r, { paddingTop: 4 }, /* @__PURE__ */ react.createElement(GridItem/* GridItem */.P, { col: 6, s: 12 }, /* @__PURE__ */ react.createElement(
...
const ApplicationInfosPage = () => {
  ...
  return /* @__PURE__ */ react.createElement(Layout/* Layout */.A, null, /* @__PURE__ */ react.createElement(build.SettingsPageTitle, { name: "Application" }), /* @__PURE__ */ react.createElement(Main/* Main */.o, null, /* @__PURE__ */ react.createElement(
    HeaderLayout/* HeaderLayout */.T,
    {
      ...
      primaryAction: /* @__PURE__ */ react.createElement(Button/* Button */.z, { onClick: handleSubmit, startIcon: /* @__PURE__ */ react.createElement(Check/* default */.Z, null) }, formatMessage({ id: "global.save", defaultMessage: "Save" }))
    }
    ...
    /* @__PURE__ */ react.createElement(Stack/* Stack */.K, { spacing: 5 }, /* @__PURE__ */ react.createElement(Typography/* Typography */.Z, { variant: "delta", as: "h3" }, formatMessage({
      id: "global.details",
  ...
  ), data && /* @__PURE__ */ react.createElement(build.CheckPermissions, { permissions }, /* @__PURE__ */ react.createElement(components_Form, { ref: inputsRef, projectSettingsStored: data }))))));
};
...
const RowLabelWithCheckbox = ({
  ...
  return /* @__PURE__ */ react.createElement(Flex/* Flex */.k, { alignItems: "center", paddingLeft: 6, style: { width: firstRowWidth, flexShrink: 0 } }, /* @__PURE__ */ react.createElement(Box/* Box */.x, { paddingRight: 2 }, /* @__PURE__ */ react.createElement(
    ...
    RowLabelWithCheckbox_spreadValues({
      title: label,
      alignItems: "center",
      isCollapsable
    }, isCollapsable && {
...
/* harmony import */ var _strapi_design_system_Box__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(35961);
/* harmony import */ var _strapi_design_system_Flex__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(46273);
/* harmony import */ var _strapi_design_system_Table__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(79031);
/* harmony import */ var _strapi_design_system_Table__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(37909);
/* harmony import */ var _strapi_design_system_Typography__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(72735);
...
const RoleRow = ({ id, name, description, usersCount, icons, rowIndex }) => {
  ...
  return /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(
    ...
    /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_strapi_design_system_Table__WEBPACK_IMPORTED_MODULE_4__.Td, null, /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_strapi_design_system_Flex__WEBPACK_IMPORTED_MODULE_6__/* .Flex */ .k, __spreadValues({ justifyContent: "flex-end" }, _strapi_helper_plugin__WEBPACK_IMPORTED_MODULE_1__.stopPropagation), icons.map(
...
const RoleListPage = () => {
  ...
  return /* @__PURE__ */ react.createElement(Main/* Main */.o, null, /* @__PURE__ */ react.createElement(build.SettingsPageTitle, { name: "Roles" }), /* @__PURE__ */ react.createElement(
    ...
    /* @__PURE__ */ react.createElement(Tbody/* Tbody */.p, null, sortedRoles == null ? void 0 : sortedRoles.map((role, rowIndex) => /* @__PURE__ */ react.createElement(
      RoleRow/* default */.Z,
      {
        key: role.id,
        id: role.id,
...
const RoleListPage = () => {
  ...
  return /* @__PURE__ */ react.createElement(Main/* Main */.o, null, /* @__PURE__ */ react.createElement(build.SettingsPageTitle, { name: "Roles" }), /* @__PURE__ */ react.createElement(
    ...
    /* @__PURE__ */ react.createElement(Tbody/* Tbody */.p, null, sortedRoles == null ? void 0 : sortedRoles.map((role, index) => /* @__PURE__ */ react.createElement(
      RoleRow/* default */.Z,
      {
        key: role.id,
        id: role.id,
