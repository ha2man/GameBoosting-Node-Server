(self["webpackChunkbackend"] = self["webpackChunkbackend"] || []).push([[9802],{
...
const s = ({ theme: r, variant: o }) => o === "danger" ? r.colors.danger100 : o === "success" ? r.colors.success100 : r.colors.primary100, c = ({ theme: r, variant: o }) => o === "danger" ? r.colors.danger200 : o === "success" ? r.colors.success200 : r.colors.primary200, n = ({ theme: r, variant: o }) => o === "danger" ? r.colors.danger700 : o === "success" ? r.colors.success700 : r.colors.primary700;
...
var Alert_s = Object.getOwnPropertySymbols;
...
const W = (0,styled_components_browser_esm["default"])(Box/* Box */.x)`
  ...
  display: flex;
  flex-direction: row;
`, z = (0,styled_components_browser_esm["default"])(Box/* Box */.x)`
  border: 1px solid ${c};
  background: ${s};
...
`, L = (0,styled_components_browser_esm["default"])(Box/* Box */.x)`
  font-size: ${20 / 16}rem;
  svg path {
    fill: ${n};
  }
`, C = (t) => {
  ...
  return e === "success" ? /* @__PURE__ */ react.createElement(CheckCircle["default"], i({}, r)) : e === "danger" ? /* @__PURE__ */ react.createElement(ExclamationMarkCircle["default"], i({}, r)) : /* @__PURE__ */ react.createElement(Information["default"], i({}, r));
}, P = (0,styled_components_browser_esm["default"])(Box/* Box */.x)`
...
`, f = (S) => {
  ...
  return /* @__PURE__ */ react.createElement(z, i({
    hasRadius: !0,
    paddingLeft: 5,
    paddingRight: 6,
    paddingTop: 5,
    variant: t
  }, b), /* @__PURE__ */ react.createElement(Flex/* Flex */.k, {
    ...
    as: "p",
    textColor: "neutral800"
  }, r)), p && /* @__PURE__ */ react.createElement(P, {
    paddingBottom: 5,
    variant: t
  }, p)), /* @__PURE__ */ react.createElement(F, {
    onClick: n,
    "aria-label": R
  }, /* @__PURE__ */ react.createElement(Cross["default"], {
    "aria-hidden": !0
  }))));
};
f.defaultProps = {
...
f.propTypes = {
  action: prop_types.element,
  children: prop_types.node.isRequired,
  closeLabel: prop_types.string.isRequired,
  onClose: prop_types.func.isRequired,
  title: prop_types.string.isRequired,
  titleAs: prop_types.string,
  variant: prop_types.oneOf(["danger", "success", "default"])
};
C.propTypes = {
...
const o = () => /* @__PURE__ */ react.createElement(VisuallyHidden/* VisuallyHidden */.T, null, /* @__PURE__ */ react.createElement("p", {
  role: "log",
  "aria-live": "polite",
...
const s = styled_components_browser_esm.createGlobalStyle`
...
`, a = ({ children: e, theme: r }) => /* @__PURE__ */ react.createElement(styled_components_browser_esm.ThemeProvider, {
  theme: r
}, /* @__PURE__ */ react.createElement(s, null), e, /* @__PURE__ */ react.createElement(o, null));
a.propTypes = {
  children: prop_types.node.isRequired,
  theme: prop_types.object.isRequired
};
...
var t = (m, o, r) => o in m ? c(m, o, { enumerable: !0, configurable: !0, writable: !0, value: r }) : m[o] = r, darkTheme_a = (m, o) => {
  for (var r in o || (o = {}))
    d.call(o, r) && t(m, r, o[r]);
  if (e)
    for (var r of e(o))
      h.call(o, r) && t(m, r, o[r]);
  return m;
};
...
var lightTheme_e = (r, o, m) => o in r ? c(r, o, { enumerable: !0, configurable: !0, writable: !0, value: m }) : r[o] = m, h = (r, o) => {
  for (var m in o || (o = {}))
    i.call(o, m) && lightTheme_e(r, m, o[m]);
  if (t)
    for (var m of t(o))
      l.call(o, m) && lightTheme_e(r, m, o[m]);
  return r;
};
...
var l = (a, e, t) => e in a ? o(a, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : a[e] = t, i = (a, e) => {
  for (var t in e || (e = {}))
    h.call(e, t) && l(a, t, e[t]);
  if (r)
    for (var t of r(e))
...
var n = (a, e, l) => e in a ? r(a, e, { enumerable: !0, configurable: !0, writable: !0, value: l }) : a[e] = l, i = (a, e) => {
  for (var l in e || (e = {}))
    d.call(e, l) && n(a, l, e[l]);
  if (t)
    for (var l of t(e))
      m.call(e, l) && n(a, l, e[l]);
  return a;
};
