...
const package_namespaceObject = {"i8":"4.5.4"};
...
const StepperModal = ({
  ...
  )), /* @__PURE__ */ react.createElement(Typography/* Typography */.Z, { variant: "alpha", fontWeight: "bold", textColor: "neutral800", as: "h3", id: "title" }, formatMessage(title))), /* @__PURE__ */ react.createElement(Flex/* Flex */.k, { alignItems: "stretch" }, /* @__PURE__ */ react.createElement(Flex/* Flex */.k, { marginRight: 8, direction: "column", justifyContent: "center", minWidth: (0,build.pxToRem)(30) }, hasSectionAfter && /* @__PURE__ */ react.createElement(react.Fragment, null, /* @__PURE__ */ react.createElement(StepLine/* default */.Z, { type: constants/* IS_DONE */.hx }), hasStepsBefore && /* @__PURE__ */ react.createElement(components_StepNumberWithPadding, { number: nextSectionIndex + 1, type: constants/* IS_ACTIVE */.lW, last: true }))), /* @__PURE__ */ react.createElement(Box/* Box */.x, null, /* @__PURE__ */ react.createElement(components_Content, __spreadValues({}, content)), cta && (cta.target ? /* @__PURE__ */ react.createElement(build.LinkButton, { endIcon: /* @__PURE__ */ react.createElement(ArrowRight/* default */.Z, null), onClick: onCtaClick, to: cta.target }, formatMessage(cta.title)) : /* @__PURE__ */ react.createElement(Button/* Button */.z, { endIcon: /* @__PURE__ */ react.createElement(ArrowRight/* default */.Z, null), onClick: onCtaClick }, formatMessage(cta.title))))), hasStepsBefore && hasSectionAfter && /* @__PURE__ */ react.createElement(Box/* Box */.x, { paddingTop: 3 }, /* @__PURE__ */ react.createElement(Flex/* Flex */.k, { marginRight: 8, justifyContent: "center", width: (0,build.pxToRem)(30) }, /* @__PURE__ */ react.createElement(StepLine/* default */.Z, { type: constants/* IS_DONE */.hx, minHeight: (0,build.pxToRem)(24) }))));
};
  ...
  if (isVisible && stepContent) {
    return /* @__PURE__ */ react.createElement(
      ...
      /* @__PURE__ */ react.createElement(
        Stepper,
        __spreadProps(Modal_spreadValues({}, stepContent), {
...
const OnboardingWrapper = (0,styled_components_browser_esm["default"])(Box/* Box */.x)`
  position: fixed;
  bottom: ${({ theme }) => theme.spaces[2]};
  right: ${({ theme }) => theme.spaces[2]};
`;
const Onboarding_Button = styled_components_browser_esm["default"].button`
...
`;
const LinksWrapper = (0,styled_components_browser_esm["default"])(Box/* Box */.x)`
  position: absolute;
  bottom: ${({ theme }) => `${theme.spaces[9]}`};
  right: 0;
  width: ${200 / 16}rem;
`;
const StyledLink = styled_components_browser_esm["default"].a`
  display: flex;
  align-items: center;
  text-decoration: none;
...
const Onboarding = () => {
  ...
  return /* @__PURE__ */ react.createElement(OnboardingWrapper, { as: "aside" }, /* @__PURE__ */ react.createElement(
    ...
    !isOpen && /* @__PURE__ */ react.createElement(index_es/* FontAwesomeIcon */.G, { icon: free_solid_svg_icons_index_es/* faQuestion */.Psp }),
    isOpen && /* @__PURE__ */ react.createElement(index_es/* FontAwesomeIcon */.G, { icon: free_solid_svg_icons_index_es/* faTimes */.NBC })
  ), isOpen && /* @__PURE__ */ react.createElement(FocusTrap/* FocusTrap */.i, { onEscape: handleClick }, /* @__PURE__ */ react.createElement(
    LinksWrapper,
    {
      background: "neutral0",
      hasRadius: true,
    ...
    staticLinks.map((link) => /* @__PURE__ */ react.createElement(
      StyledLink,
      {
        key: link.label,
      ...
      /* @__PURE__ */ react.createElement(index_es/* FontAwesomeIcon */.G, { icon: link.icon }),
      /* @__PURE__ */ react.createElement(Typography/* Typography */.Z, null, link.label)
    ))
  )));
};
...
const CM = (0,react.lazy)(
  () => Promise.all(/* import() | content-manager */[__webpack_require__.e(5926), __webpack_require__.e(8702), __webpack_require__.e(118), __webpack_require__.e(6593), __webpack_require__.e(994)]).then(__webpack_require__.bind(__webpack_require__, 4085))
);
...
const SettingsPage = (0,react.lazy)(
  () => Promise.all(/* import() | Admin_settingsPage */[__webpack_require__.e(5926), __webpack_require__.e(1534), __webpack_require__.e(5895)]).then(__webpack_require__.bind(__webpack_require__, 93500))
);
const useTrackUsage = () => {
  const { trackUsage } = (0,build.useTracking)();
...
var AuthenticatedApp_async = (__this, __arguments, generator) => {
  return new Promise((resolve, reject) => {
    var fulfilled = (value) => {
      try {
        step(generator.next(value));
...
const AuthenticatedApp = () => {
  ...
  (0,react.useEffect)(() => {
    const getUserId = () => AuthenticatedApp_async(void 0, null, function* () {
      const userId2 = yield (0,utils/* hashAdminUserEmail */.Qy)(userInfo);
      setUserId(userId2);
    });
    getUserId();
  }, [userInfo]);
...
/* harmony import */ var _strapi_design_system_Box__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(35961);
...
/* harmony import */ var _strapi_helper_plugin__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(68547);
/* harmony import */ var _strapi_helper_plugin__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_strapi_helper_plugin__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _strapi_design_system_Flex__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(46273);
/* harmony import */ var _strapi_design_system_Typography__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(72735);
