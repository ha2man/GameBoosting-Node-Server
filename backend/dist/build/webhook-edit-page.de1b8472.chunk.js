...
const HeadersInput = () => {
  ...
  return /* @__PURE__ */ react.createElement(Stack/* Stack */.K, { spacing: 1 }, /* @__PURE__ */ react.createElement(FieldLabel/* FieldLabel */.Q, null, formatMessage({
    ...
    dist.FieldArray,
    {
      ...
      render: ({ push, remove }) => {
        var _a;
        return /* @__PURE__ */ react.createElement(Grid/* Grid */.r, { gap: 4 }, (_a = values.headers) == null ? void 0 : _a.map((header, i) => {
          var _a2, _b, _c, _d, _e, _f, _g, _h, _i, _j;
          return /* @__PURE__ */ react.createElement(react.Fragment, { key: i }, /* @__PURE__ */ react.createElement(GridItem/* GridItem */.P, { col: 6 }, /* @__PURE__ */ react.createElement(
            dist.Field,
            {
...
const Status = ({ isPending, statusCode }) => {
  const { formatMessage } = (0,react_intl.useIntl)();
  if (isPending) {
    return /* @__PURE__ */ react.createElement(Stack/* Stack */.K, { horizontal: true, spacing: 2, style: { alignItems: "center" } }, /* @__PURE__ */ react.createElement(Icon, { as: Loader["default"] }), /* @__PURE__ */ react.createElement(Typography/* Typography */.Z, null, formatMessage({ id: "Settings.webhooks.trigger.pending", defaultMessage: "pending" })));
  }
