...
const DragPreviewBox = (0,styled_components_browser_esm["default"])(Box/* Box */.x)`
  border: 1px solid ${({ theme }) => theme.colors.neutral200};
`;
const DropdownIconWrapper = (0,styled_components_browser_esm["default"])(Box/* Box */.x)`
  height: ${32 / 16}rem;
  width: ${32 / 16}rem;
  border-radius: 50%;
  display: flex;
...
const DragPreview = ({ displayedValue }) => {
  return /* @__PURE__ */ react.createElement(
    ...
    /* @__PURE__ */ react.createElement(Flex/* Flex */.k, { justifyContent: "space-between" }, /* @__PURE__ */ react.createElement(ToggleButton, { type: "button" }, /* @__PURE__ */ react.createElement(Flex/* Flex */.k, null, /* @__PURE__ */ react.createElement(DropdownIconWrapper, { background: "neutral200" }, /* @__PURE__ */ react.createElement(CarretDown["default"], null)), /* @__PURE__ */ react.createElement(Box/* Box */.x, { paddingLeft: 6, maxWidth: (0,build.pxToRem)(150) }, /* @__PURE__ */ react.createElement(Typography/* Typography */.Z, { textColor: "neutral700", ellipsis: true }, displayedValue)))), /* @__PURE__ */ react.createElement(Box/* Box */.x, { paddingLeft: 3 }, /* @__PURE__ */ react.createElement(Flex/* Flex */.k, null, /* @__PURE__ */ react.createElement(IconButton/* IconButton */.h, { icon: /* @__PURE__ */ react.createElement(Trash["default"], null) }), /* @__PURE__ */ react.createElement(Box/* Box */.x, { paddingLeft: 2 }, /* @__PURE__ */ react.createElement(IconButton/* IconButton */.h, { icon: /* @__PURE__ */ react.createElement(Drag/* default */.Z, null) })))))
  );
};
...
const InjectionZone = (_a) => {
  ...
  return compos.map((compo) => /* @__PURE__ */ react.createElement(compo.Component, InjectionZone_spreadValues({ key: compo.name }, props)));
};
...
const ComponentInitializer = ({ error, isReadOnly, onClick }) => {
  ...
  ), (error == null ? void 0 : error.id) && /* @__PURE__ */ react.createElement(Typography/* Typography */.Z, { textColor: "danger600", variant: "pi" }, formatMessage(
    {
      id: error.id,
  ...
  if (isExpandMode) {
    return /* @__PURE__ */ react.createElement(Portal/* Portal */.h, { role: "dialog", "aria-modal": false }, /* @__PURE__ */ react.createElement(FocusTrap/* FocusTrap */.i, { onEscape: onCollapse }, /* @__PURE__ */ react.createElement(
      ...
      /* @__PURE__ */ react.createElement(
        ...
        /* @__PURE__ */ react.createElement(Flex/* Flex */.k, { height: "100%", alignItems: "flex-start" }, /* @__PURE__ */ react.createElement(BoxWithBorder, { flex: "1", height: "100%" }, children), /* @__PURE__ */ react.createElement(Box/* Box */.x, { flex: "1", height: "100%" }, /* @__PURE__ */ react.createElement(Flex/* Flex */.k, { height: (0,build.pxToRem)(48), background: "neutral100", justifyContent: "flex-end" }, /* @__PURE__ */ react.createElement(EditorLayout_ExpandButton, { id: "collapse", onClick: onCollapse }, /* @__PURE__ */ react.createElement(Typography/* Typography */.Z, null, formatMessage({
          id: "components.Wysiwyg.collapse",
          defaultMessage: "Collapse"
        })), /* @__PURE__ */ react.createElement(Collapse/* default */.Z, null))), /* @__PURE__ */ react.createElement(Box/* Box */.x, { position: "relative", height: "100%" }, /* @__PURE__ */ react.createElement(components_PreviewWysiwyg, { data: previewContent }))))
      )
    )));
  }
  return /* @__PURE__ */ react.createElement(
...
const Wysiwyg_Wysiwyg = ({
  ...
  return /* @__PURE__ */ react.createElement(react.Fragment, null, /* @__PURE__ */ react.createElement(Stack/* Stack */.K, { spacing: 1 }, /* @__PURE__ */ react.createElement(Stack/* Stack */.K, { horizontal: true, spacing: 1 }, /* @__PURE__ */ react.createElement(Typography/* Typography */.Z, { variant: "pi", fontWeight: "bold", textColor: "neutral800" }, label, required && /* @__PURE__ */ react.createElement(TypographyAsterisk, { textColor: "danger600" }, "*")), labelAction && /* @__PURE__ */ react.createElement(LabelAction, { paddingLeft: 1 }, labelAction)), /* @__PURE__ */ react.createElement(
    EditorLayout,
    {
      isExpandMode,
      error,
  ...
  ), /* @__PURE__ */ react.createElement(components_Hint, { description, name, error })), error && /* @__PURE__ */ react.createElement(Box/* Box */.x, { paddingTop: 1 }, /* @__PURE__ */ react.createElement(Typography/* Typography */.Z, { variant: "pi", textColor: "danger600", "data-strapi-field-error": true }, error)), mediaLibVisible && /* @__PURE__ */ react.createElement(MediaLibraryDialog, { onClose: handleToggleMediaLib, onSelectAssets: handleSelectAssets }));
};
...
const Label_LabelAction = (0,styled_components_browser_esm["default"])(Box/* Box */.x)`
  svg path {
    fill: ${({ theme }) => theme.colors.neutral500};
  }
`;
const Label = ({ intlLabel, labelAction, name, required }) => {
  ...
  return /* @__PURE__ */ react.createElement(Flex/* Flex */.k, null, /* @__PURE__ */ react.createElement(FieldLabel/* FieldLabel */.Q, { required }, label), labelAction && /* @__PURE__ */ react.createElement(Label_LabelAction, { paddingLeft: 1 }, labelAction));
};
Label.defaultProps = {
  id: void 0,
  intlLabel: void 0,
...
const FieldWrapper = ({ name, hint, error, children }) => {
  ...
  return /* @__PURE__ */ react.createElement(Field/* Field */.g, { name, hint: hint && formatMessage(hint), error: errorMessage, id: name }, children);
};
...
class InputJSON extends react.Component {
  ...
  render() {
    ...
    return /* @__PURE__ */ react.createElement(InputJSON_FieldWrapper, { name: this.props.name, hint: this.props.description, error: this.props.error }, /* @__PURE__ */ react.createElement(Stack/* Stack */.K, { spacing: 1 }, /* @__PURE__ */ react.createElement(
      InputJSON_Label,
      {
...
const InputUID = ({
  ...
  return /* @__PURE__ */ react.createElement(
    TextInput/* TextInput */.o,
    {
      disabled,
      error,
      endAction: /* @__PURE__ */ react.createElement(EndActionWrapper, null, availability && availability.isAvailable && !regenerateLabel && /* @__PURE__ */ react.createElement(TextValidation, { alignItems: "center", justifyContent: "flex-end" }, /* @__PURE__ */ react.createElement(CheckCircle["default"], null), /* @__PURE__ */ react.createElement(Typography/* Typography */.Z, { textColor: "success600", variant: "pi" }, formatMessage({
        ...
        isLoading ? /* @__PURE__ */ react.createElement(LoadingWrapper, null, /* @__PURE__ */ react.createElement(Loader["default"], null)) : /* @__PURE__ */ react.createElement(Refresh/* default */.Z, null)
      )),
      hint,
      label,
      labelAction,
...
const Relation = (_a) => {
  ...
  return /* @__PURE__ */ react.createElement(react.Fragment, null, /* @__PURE__ */ react.createElement(
    ...
    /* @__PURE__ */ react.createElement(Stack/* Stack */.K, Relation_spreadValues({ basis: size <= 6 ? "100%" : "70%", spacing: 1 }, props), search),
    loadMore
  ), children);
};
...
const RelationItem = (_a) => {
  ...
  return /* @__PURE__ */ react.createElement(Box/* Box */.x, { style, as: "li" }, /* @__PURE__ */ react.createElement(
    Flex/* Flex */.k,
    RelationItem_spreadValues({
      paddingTop: 2,
      paddingBottom: 2,
      paddingLeft: 4,
      paddingRight: 4,
    ...
    /* @__PURE__ */ react.createElement(ChildrenWrapper, { justifyContent: "space-between" }, children),
...
const RelationList = (_a) => {
  ...
  return /* @__PURE__ */ react.createElement(ShadowBox, RelationList_spreadValues({ overflowDirection: overflow }, props), /* @__PURE__ */ react.createElement(Stack/* Stack */.K, { spacing: 1 }, children));
};
...
const Option_Option = (props) => {
  ...
  if (publicationState) {
    ...
    return /* @__PURE__ */ react.createElement(Component, Option_spreadValues({}, props), /* @__PURE__ */ react.createElement(Flex/* Flex */.k, null, /* @__PURE__ */ react.createElement(StyledBullet, { title, isDraft }), /* @__PURE__ */ react.createElement(Typography/* Typography */.Z, { ellipsis: true }, mainField != null ? mainField : id)));
  }
...
const RelationInput = ({
  ...
  return /* @__PURE__ */ react.createElement(Field/* Field */.g, { error, name, hint: description, id }, /* @__PURE__ */ react.createElement(
    Relation,
    {
      totalNumberOfRelations,
      size,
      search: /* @__PURE__ */ react.createElement(react.Fragment, null, /* @__PURE__ */ react.createElement(FieldLabel/* FieldLabel */.Q, { action: labelAction, required }, label), /* @__PURE__ */ react.createElement(
        build.ReactSelect,
        {
    ...
    /* @__PURE__ */ react.createElement(RelationList, { overflow }, /* @__PURE__ */ react.createElement(
      ...
      ({ data: data2, index, style }) => {
        ...
        return /* @__PURE__ */ react.createElement(
          ...
          /* @__PURE__ */ react.createElement(Box/* Box */.x, { minWidth: 0, paddingTop: 1, paddingBottom: 1, paddingRight: 4 }, /* @__PURE__ */ react.createElement(Tooltip/* Tooltip */.u, { description: mainField != null ? mainField : `${id2}` }, href ? /* @__PURE__ */ react.createElement(LinkEllipsis, { to: href, disabled }, mainField != null ? mainField : id2) : /* @__PURE__ */ react.createElement(Typography/* Typography */.Z, { textColor: disabled ? "neutral600" : "primary600", ellipsis: true }, mainField != null ? mainField : id2))),
...
const RelationInputDataManager = ({
  ...
  const { relations, search, searchFor } = useRelation(`${slug}-${name}-${(_a = initialData == null ? void 0 : initialData.id) != null ? _a : ""}`, {
    name,
    relation: {
  ...
  const serverRelationsCount = ((_b = get_default()(initialData, name)) != null ? _b : []).length;
  const realServerRelationsCount = (_f = (_e = (_d = (_c = relations.data) == null ? void 0 : _c.pages[0]) == null ? void 0 : _d.pagination) == null ? void 0 : _e.total) != null ? _f : 0;
...
function Inputs({
  ...
  if (type === "relation") {
    return /* @__PURE__ */ react.createElement(
      ...
      Inputs_spreadProps(Inputs_spreadValues(Inputs_spreadValues({}, metadatas), fieldSchema), {
        componentUid,
  ...
  const customInputs = Inputs_spreadValues(Inputs_spreadValues({
...
var useLazyComponents_async = (__this, __arguments, generator) => {
  return new Promise((resolve, reject) => {
    var fulfilled = (value) => {
      try {
        step(generator.next(value));
...
const useLazyComponents = (componentUids = []) => {
  ...
  (0,react.useEffect)(() => {
    ...
    const lazyLoadComponents = (uids, components) => useLazyComponents_async(void 0, null, function* () {
      const modules = yield Promise.all(components);
...
const IconButtonCustoms_CustomIconButton = (0,styled_components_browser_esm["default"])(IconButton/* IconButton */.h)`
  background-color: transparent;
...
`;
const CustomIconButtonSibling = (0,styled_components_browser_esm["default"])(IconButton/* IconButton */.h)`
  background-color: transparent;
...
const SiblingWrapper = styled_components_browser_esm["default"].span`
  display: flex;
  ...
  height: ${50 / 16}rem;
`;
const DraggingSibling_ToggleButton = (0,styled_components_browser_esm["default"])(TextButton/* TextButton */.A)`
  text-align: left;
...
const DraggingSibling = ({ displayedValue }) => {
  return /* @__PURE__ */ react.createElement(SiblingWrapper, null, /* @__PURE__ */ react.createElement(Stack/* Stack */.K, { horizontal: true, spacing: 3, flex: 1 }, /* @__PURE__ */ react.createElement(
    Flex/* Flex */.k,
    {
      justifyContent: "center",
      borderRadius: "50%",
    ...
    /* @__PURE__ */ react.createElement(Icon/* Icon */.J, { as: CarretDown["default"], width: `${8 / 16}rem}`, color: "neutral600" })
  ), /* @__PURE__ */ react.createElement(DraggingSibling_ToggleButton, { onClick: () => {
  }, flex: 1 }, /* @__PURE__ */ react.createElement(Typography/* Typography */.Z, { fontWeight: "bold", textColor: "neutral700" }, displayedValue))), /* @__PURE__ */ react.createElement(Stack/* Stack */.K, { horizontal: true, spacing: 0 }, /* @__PURE__ */ react.createElement(CustomIconButtonSibling, { noBorder: true, onClick: () => {
  }, icon: /* @__PURE__ */ react.createElement(Trash["default"], null) }), /* @__PURE__ */ react.createElement(CustomIconButtonSibling, { icon: /* @__PURE__ */ react.createElement(Drag/* default */.Z, null), noBorder: true })));
};
...
const DraggedItem_DragButton = styled_components_browser_esm["default"].span`
  display: flex;
  align-items: center;
  height: ${({ theme }) => theme.spaces[7]};
...
const DraggedItem = ({
  ...
  const { lazyComponentStore } = hooks_useLazyComponents();
  return /* @__PURE__ */ react.createElement(Box/* Box */.x, { ref: refs ? refs.dropRef : null }, isDragging && /* @__PURE__ */ react.createElement(DraggedItem_Preview, null), !isDragging && isDraggingSibling && /* @__PURE__ */ react.createElement(DraggedItem_DraggingSibling, { displayedValue: accordionTitle, componentFieldName }), !isDragging && !isDraggingSibling && /* @__PURE__ */ react.createElement(
    ...
    /* @__PURE__ */ react.createElement(
      ...
      {
        action: isReadOnly ? null : /* @__PURE__ */ react.createElement(Stack/* Stack */.K, { horizontal: true, spacing: 0 }, /* @__PURE__ */ react.createElement(
          IconButtonCustoms_CustomIconButton,
          {
            expanded: isOpen,
            noBorder: true,
            onClick: () => {
    ...
    /* @__PURE__ */ react.createElement(AccordionContent/* AccordionContent */.v, null, /* @__PURE__ */ react.createElement(Stack/* Stack */.K, { background: "neutral100", padding: 6, spacing: 6 }, fields.map((fieldRow, key) => {
      return /* @__PURE__ */ react.createElement(Grid/* Grid */.r, { gap: 4, key }, fieldRow.map(({ name, fieldSchema, metadatas, queryInfos, size }) => {
        const isComponent = fieldSchema.type === "component";
...
const AccordionFooter = (0,styled_components_browser_esm["default"])(Box/* Box */.x)`
  overflow: hidden;
...
`;
const EnhancedGroup = (0,styled_components_browser_esm["default"])(Box/* Box */.x)`
  > div {
    & > * {
      border-radius: unset;
      border-right: 1px solid ${({ theme }) => theme.colors.neutral200};
  ...
  `}
`;
const AccordionGroupCustom_LabelAction = (0,styled_components_browser_esm["default"])(Box/* Box */.x)`
  svg path {
    fill: ${({ theme }) => theme.colors.neutral500};
  }
`;
const AccordionGroupCustom = ({ children, footer, label, labelAction, error }) => {
  ...
  return /* @__PURE__ */ react.createElement(KeyboardNavigable/* KeyboardNavigable */.k, { attributeName: "data-strapi-accordion-toggle" }, label && /* @__PURE__ */ react.createElement(Flex/* Flex */.k, { paddingBottom: 1 }, /* @__PURE__ */ react.createElement(Typography/* Typography */.Z, { as: "label", textColor: "neutral800", variant: "pi", fontWeight: "bold" }, label), labelAction && /* @__PURE__ */ react.createElement(AccordionGroupCustom_LabelAction, { paddingLeft: 1 }, labelAction)), /* @__PURE__ */ react.createElement(EnhancedGroup, { footer }, childrenArray), footer && /* @__PURE__ */ react.createElement(AccordionFooter, null, footer), error && /* @__PURE__ */ react.createElement(Box/* Box */.x, { paddingTop: 1 }, /* @__PURE__ */ react.createElement(Typography/* Typography */.Z, { variant: "pi", textColor: "danger600" }, formatMessage({ id: error.id, defaultMessage: error.id }, AccordionGroupCustom_spreadValues({}, error.values)))));
};
...
const RepeatableComponent = ({
  ...
  return /* @__PURE__ */ react.createElement(Box/* Box */.x, { hasRadius: true, ref: drop }, /* @__PURE__ */ react.createElement(
    RepeatableComponent_AccordionGroupCustom,
    {
      error: errorMessage,
      footer: /* @__PURE__ */ react.createElement(Flex/* Flex */.k, { justifyContent: "center", height: "48px", background: "neutral0" }, /* @__PURE__ */ react.createElement(TextButtonCustom, { disabled: isReadOnly, onClick: handleClick, startIcon: /* @__PURE__ */ react.createElement(Plus["default"], null) }, formatMessage({
    ...
    componentValue.map((data, index) => {
      ...
      return /* @__PURE__ */ react.createElement(
        RepeatableComponent_DraggedItem,
        {
          componentFieldName,
          componentUid,
          hasErrors,
...
const FieldComponent_Label_LabelAction = (0,styled_components_browser_esm["default"])(Box/* Box */.x)`
  svg path {
    fill: ${({ theme }) => theme.colors.neutral500};
  }
`;
const Label_Label = ({
  ...
  ), labelAction && /* @__PURE__ */ react.createElement(FieldComponent_Label_LabelAction, { paddingLeft: 1 }, labelAction)));
};
...
`;
const DynamicComponent_StyledBox = (0,styled_components_browser_esm["default"])(Box/* Box */.x)`
  > div:first-child {
...
const DynamicZoneComponent = ({
  ...
  return /* @__PURE__ */ react.createElement(Box/* Box */.x, null, /* @__PURE__ */ react.createElement(Flex/* Flex */.k, { justifyContent: "center" }, /* @__PURE__ */ react.createElement(Rectangle, { background: "neutral200" })), /* @__PURE__ */ react.createElement(DynamicComponent_StyledBox, { hasRadius: true }, /* @__PURE__ */ react.createElement(Accordion/* Accordion */.U, { expanded: isOpen, onToggle: handleToggle, size: "S", error: errorMessage }, /* @__PURE__ */ react.createElement(
    AccordionToggle/* AccordionToggle */.B,
    {
      startIcon: icon && /* @__PURE__ */ react.createElement(index_es/* FontAwesomeIcon */.G, { icon }),
      action: /* @__PURE__ */ react.createElement(Stack/* Stack */.K, { horizontal: true, spacing: 0, expanded: isOpen }, showDownIcon && /* @__PURE__ */ react.createElement(
        IconButtonCustom,
        {
          noBorder: true,
          label: formatMessage({
          ...
          icon: /* @__PURE__ */ react.createElement(ArrowDown/* default */.Z, null)
        }
      ), showUpIcon && /* @__PURE__ */ react.createElement(
        IconButtonCustom,
        {
          noBorder: true,
          label: formatMessage({
          ...
          icon: /* @__PURE__ */ react.createElement(ArrowUp/* default */.Z, null)
        }
      ), isFieldAllowed && /* @__PURE__ */ react.createElement(
        IconButtonCustom,
        {
          noBorder: true,
          label: formatMessage(
...
function ComponentCard({ children, icon, onClick }) {
  return /* @__PURE__ */ react.createElement("button", { type: "button", onClick }, /* @__PURE__ */ react.createElement(ComponentBox, { borderRadius: "borderRadius" }, /* @__PURE__ */ react.createElement(Stack/* Stack */.K, { spacing: 1, style: { justifyContent: "center", alignItems: "center" } }, /* @__PURE__ */ react.createElement(StyledFontAwesomeIcon, { "data-testid": "component-card-icon", icon }), /* @__PURE__ */ react.createElement(Typography/* Typography */.Z, { variant: "pi", fontWeight: "bold", textColor: "neutral600" }, children))));
}
...
const ComponentCategory = ({ category, components, variant, isOpen, onAddComponent, onToggle }) => {
  ...
  ), /* @__PURE__ */ react.createElement(AccordionContent/* AccordionContent */.v, null, /* @__PURE__ */ react.createElement(Box/* Box */.x, { paddingTop: 4, paddingBottom: 4, paddingLeft: 3, paddingRight: 3 }, /* @__PURE__ */ react.createElement(ComponentCategory_Grid, null, components.map(({ componentUid, info: { displayName, icon } }) => /* @__PURE__ */ react.createElement(ComponentCard, { key: componentUid, icon, onClick: onAddComponent(componentUid) }, formatMessage({ id: displayName, defaultMessage: displayName })))))));
};
...
const DynamicZone = ({
  ...
  return /* @__PURE__ */ react.createElement(Stack/* Stack */.K, { spacing: 6 }, dynamicDisplayedComponentsLength > 0 && /* @__PURE__ */ react.createElement(Box/* Box */.x, null, /* @__PURE__ */ react.createElement(
...
const EditViewDataManagerProvider = ({
  ...
  (0,react.useEffect)(() => {
    if (initialValues && (currentContentTypeLayout == null ? void 0 : currentContentTypeLayout.attributes) && !isEqual_default()(previousInitialValues, initialValues)) {
...
const SingleTypeFormWrapper = ({ allLayoutData, children, slug }) => {
  ...
  (0,react.useEffect)(() => {
    ...
    const fetchData = (source2) => SingleTypeFormWrapper_async(void 0, null, function* () {
      ...
      try {
        const { data: data2 } = yield utils/* axiosInstance.get */.be.get(SingleTypeFormWrapper_utils_getRequestUrl(`${slug}${searchToSend}`), {
...
const CustomBullet = (0,styled_components_browser_esm["default"])(Dot["default"])`
  width: ${(0,build.pxToRem)(6)};
  height: ${(0,build.pxToRem)(6)};
  * {
...
const DraftAndPublishBadge = ({ hasDraftAndPublish, isPublished }) => {
  ...
  return /* @__PURE__ */ react.createElement(
    Box/* Box */.x,
    DraftAndPublishBadge_spreadValues({
      hasRadius: true,
      as: "aside",
      paddingTop: 4,
      paddingBottom: 4,
...
const Informations = () => {
  ...
  return /* @__PURE__ */ react.createElement(Box/* Box */.x, null, /* @__PURE__ */ react.createElement(Typography/* Typography */.Z, { variant: "sigma", textColor: "neutral600", id: "additional-informations" }, formatMessage({
    id: utils_getTrad("containers.Edit.information"),
    defaultMessage: "Information"
  })), /* @__PURE__ */ react.createElement(Box/* Box */.x, { paddingTop: 2, paddingBottom: 6 }, /* @__PURE__ */ react.createElement(Divider/* Divider */.i, null)), /* @__PURE__ */ react.createElement(Stack/* Stack */.K, { spacing: 4 }, /* @__PURE__ */ react.createElement(Flex/* Flex */.k, { justifyContent: "space-between" }, /* @__PURE__ */ react.createElement(Typography/* Typography */.Z, { fontWeight: "bold" }, formatMessage({
    id: utils_getTrad("containers.Edit.information.created"),
    defaultMessage: "Created"
  })), /* @__PURE__ */ react.createElement(Typography/* Typography */.Z, null, created.at)), /* @__PURE__ */ react.createElement(Flex/* Flex */.k, { justifyContent: "space-between" }, /* @__PURE__ */ react.createElement(Typography/* Typography */.Z, { fontWeight: "bold" }, formatMessage({
    id: utils_getTrad("containers.Edit.information.by"),
    defaultMessage: "By"
  })), /* @__PURE__ */ react.createElement(Typography/* Typography */.Z, null, created.by)), /* @__PURE__ */ react.createElement(Flex/* Flex */.k, { justifyContent: "space-between" }, /* @__PURE__ */ react.createElement(Typography/* Typography */.Z, { fontWeight: "bold" }, formatMessage({
    id: utils_getTrad("containers.Edit.information.lastUpdate"),
    defaultMessage: "Last update"
  })), /* @__PURE__ */ react.createElement(Typography/* Typography */.Z, null, updated.at)), /* @__PURE__ */ react.createElement(Flex/* Flex */.k, { justifyContent: "space-between" }, /* @__PURE__ */ react.createElement(Typography/* Typography */.Z, { fontWeight: "bold" }, formatMessage({
    id: utils_getTrad("containers.Edit.information.by"),
    defaultMessage: "By"
  })), /* @__PURE__ */ react.createElement(Typography/* Typography */.Z, null, updated.by))));
};
...
const Header = ({
  ...
  if (isCreatingEntry && canCreate) {
    primaryAction = /* @__PURE__ */ react.createElement(Stack/* Stack */.K, { horizontal: true, spacing: 2 }, hasDraftAndPublish && /* @__PURE__ */ react.createElement(Button/* Button */.z, { disabled: true, startIcon: /* @__PURE__ */ react.createElement(Check/* default */.Z, null), variant: "secondary" }, formatMessage({ id: "app.utils.publish", defaultMessage: "Publish" })), /* @__PURE__ */ react.createElement(Button/* Button */.z, { disabled: !didChangeData, isLoading: status === "submit-pending", type: "submit" }, formatMessage({
...
const selectAttributesLayout = (0,es/* createSelector */.P1)(
  ...
  (layout) => {
    var _a;
    return utils_createAttributesLayout((_a = layout == null ? void 0 : layout.contentType) != null ? _a : {});
  }
);
  ...
  return /* @__PURE__ */ react.createElement(DataManagementWrapper, { allLayoutData: layout, slug, id, origin }, ({
    ...
    return /* @__PURE__ */ react.createElement(
      ...
      /* @__PURE__ */ react.createElement(Main/* Main */.o, { "aria-busy": status !== "resolved" }, /* @__PURE__ */ react.createElement(EditView_Header, { allowedActions }), /* @__PURE__ */ react.createElement(ContentLayout/* ContentLayout */.D, null, /* @__PURE__ */ react.createElement(Grid/* Grid */.r, { gap: 4 }, /* @__PURE__ */ react.createElement(GridItem/* GridItem */.P, { col: 9, s: 12 }, /* @__PURE__ */ react.createElement(Stack/* Stack */.K, { spacing: 6 }, formattedContentTypeLayout.map((row, index) => {
        ...
        /* @__PURE__ */ react.createElement(EditView_Informations, null),
...
const Permissions = (props) => {
  ...
  return /* @__PURE__ */ react.createElement(pages_EditView, Permissions_spreadProps(Permissions_spreadValues({}, props), { allowedActions }));
};
...
const EditViewLayoutManager = (_a) => {
  ...
  return /* @__PURE__ */ react.createElement(EditViewLayoutManager_Permissions, EditViewLayoutManager_spreadProps(EditViewLayoutManager_spreadValues({}, rest), { userPermissions: permissions }));
};
...
const EditSettingsView_reducer_reducer = (state = EditSettingsView_reducer_initialState, action) => (0,immer_esm["default"])(state, (draftState) => {
  var _a, _b, _c;
...
const ComponentFieldList = ({ componentUid }) => {
  ...
  return /* @__PURE__ */ react.createElement(Box/* Box */.x, { padding: 3 }, componentLayout.map((row, index) => /* @__PURE__ */ react.createElement(Grid/* Grid */.r, { gap: 4, key: index }, row.map((rowContent) => /* @__PURE__ */ react.createElement(GridItem/* GridItem */.P, { key: rowContent.name, col: rowContent.size }, /* @__PURE__ */ react.createElement(Box/* Box */.x, { paddingTop: 2 }, /* @__PURE__ */ react.createElement(
    Flex/* Flex */.k,
    {
      alignItems: "center",
      background: "neutral0",
...
const DynamicZoneList = ({ components }) => {
  const { componentLayouts } = hooks_useLayoutDnd();
  return /* @__PURE__ */ react.createElement(Stack/* Stack */.K, { spacing: 2, horizontal: true, overflow: "scroll hidden", padding: 3 }, components.map((componentUid) => /* @__PURE__ */ react.createElement(
    CustomLink,
    {
      hasRadius: true,
      background: "neutral0",
    ...
    /* @__PURE__ */ react.createElement(
      ...
      /* @__PURE__ */ react.createElement(index_es/* FontAwesomeIcon */.G, { icon: get_default()(componentLayouts, [componentUid, "info", "icon"], "") })
    ),
    /* @__PURE__ */ react.createElement(Box/* Box */.x, { paddingTop: 1 }, /* @__PURE__ */ react.createElement(Typography/* Typography */.Z, { fontSize: 1, textColor: "neutral600", fontWeight: "bold" }, get_default()(componentLayouts, [componentUid, "info", "displayName"], "")))
  )));
};
...
const FieldButtonContent = ({ attribute, onEditField, onDeleteField, children }) => {
  ...
  ))), (attribute == null ? void 0 : attribute.type) === "component" && /* @__PURE__ */ react.createElement(components_ComponentFieldList, { componentUid: attribute.component }), (attribute == null ? void 0 : attribute.type) === "dynamiczone" && /* @__PURE__ */ react.createElement(components_DynamicZoneList, { components: attribute.components }));
};
...
`;
const DisplayedFieldButton_CustomFlex = (0,styled_components_browser_esm["default"])(Flex/* Flex */.k)`
...
const DisplayedFieldButton = ({
  ...
  return /* @__PURE__ */ react.createElement(GridItem/* GridItem */.P, { col: size }, /* @__PURE__ */ react.createElement(
    ...
    /* @__PURE__ */ react.createElement(
      DisplayedFieldButton_CustomFlex,
      {
...
const GenericInput = (_a) => {
  ...
  switch (type) {
    case "text": {
      return /* @__PURE__ */ react.createElement(TextInput/* TextInput */.o, GenericInput_spreadValues({ onChange, value, name }, inputProps));
    }
    case "bool": {
      return /* @__PURE__ */ react.createElement(
        ToggleInput/* ToggleInput */.s,
        GenericInput_spreadValues({
          onChange: (e) => {
...
const FileWrapper = (_a) => {
  ...
  return /* @__PURE__ */ react.createElement(FileWrapper_Wrapper, FileWrapper_spreadValues({ justifyContent: "center", alignItems: "center", as: "span" }, props), /* @__PURE__ */ react.createElement(Typography/* Typography */.Z, { variant: "sigma", textColor: "neutral600" }, children));
};
...
const MultipleMedia = ({ value }) => {
  return /* @__PURE__ */ react.createElement(AvatarGroup/* AvatarGroup */.H, null, value.map((file, index) => {
    ...
    return /* @__PURE__ */ react.createElement(CellContent_Media, MultipleMedias_spreadValues({ key }, file));
  }));
};
...
const RelationMultiple = ({ fieldSchema, metadatas, name, entityId, value, contentType }) => {
  ...
  return /* @__PURE__ */ react.createElement(Box/* Box */.x, RelationMultiple_spreadValues({}, build.stopPropagation), /* @__PURE__ */ react.createElement(
    SimpleMenu/* SimpleMenu */.O,
    {
      label: Label,
      size: "S",
    ...
    status === "success" && /* @__PURE__ */ react.createElement(react.Fragment, null, data == null ? void 0 : data.results.map((entry) => /* @__PURE__ */ react.createElement(SimpleMenu/* MenuItem */.s, { key: entry.id, "aria-disabled": true }, /* @__PURE__ */ react.createElement(TypographyMaxWidth, { ellipsis: true }, /* @__PURE__ */ react.createElement(
      CellContent_CellValue,
      {
        type: metadatas.mainField.schema.type,
        value: entry[metadatas.mainField.name] || entry.id
      }
    )))), (data == null ? void 0 : data.pagination.total) > 10 && /* @__PURE__ */ react.createElement(
...
const TableRows = ({
  ...
  return /* @__PURE__ */ react.createElement(Tbody/* Tbody */.p, null, rows.map((data, index) => {
    ...
    return /* @__PURE__ */ react.createElement(
      ...
      withMainAction && /* @__PURE__ */ react.createElement(Cell.Td, TableRows_spreadValues({}, build.stopPropagation), /* @__PURE__ */ react.createElement(
      ...
      headers.map((_a) => {
        ...
        return /* @__PURE__ */ react.createElement(Cell.Td, { key }, typeof cellFormatter === "function" ? cellFormatter(data, TableRows_spreadValues({ key, name }, rest)) : /* @__PURE__ */ react.createElement(
          DynamicTable_CellContent,
          TableRows_spreadProps(TableRows_spreadValues({
      ...
      withBulkActions && /* @__PURE__ */ react.createElement(Cell.Td, null, /* @__PURE__ */ react.createElement(Flex/* Flex */.k, TableRows_spreadValues({ justifyContent: "end" }, build.stopPropagation), /* @__PURE__ */ react.createElement(
        IconButton/* IconButton */.h,
        {
...
const InjectionZoneList = (_a) => {
  ...
  return /* @__PURE__ */ react.createElement("ul", null, compos.map((compo) => {
    ...
    if (component) {
      return /* @__PURE__ */ react.createElement(Box/* Box */.x, { key: compo.name, padding: 3, style: { textAlign: "center" } }, /* @__PURE__ */ react.createElement(compo.Component, InjectionZoneList_spreadValues({}, props)));
    }
    return null;
  }));
};
...
function ListView({
  ...
  const getCreateAction = (props) => canCreate ? /* @__PURE__ */ react.createElement(
    Button/* Button */.z,
    ListView_spreadProps(ListView_spreadValues({}, props), {
      forwardedAs: react_router_dom_min.Link,
      onClick: () => {
  ...
  ), /* @__PURE__ */ react.createElement(ListView_PaginationFooter, { pagination: { pageCount: (pagination == null ? void 0 : pagination.pageCount) || 1 } })) : /* @__PURE__ */ react.createElement(build.NoPermissions, null)));
}
ListView.propTypes = {
  canCreate: (prop_types_default()).bool.isRequired,
  canDelete: (prop_types_default()).bool.isRequired,
...
const ListViewLayout = (_a) => {
  ...
  return /* @__PURE__ */ react.createElement(ListViewLayoutManager_Permissions, ListViewLayoutManager_spreadProps(ListViewLayoutManager_spreadValues({}, props), { layout, permissions }));
};
...
const ListSettingsView_reducer_reducer = (state = ListSettingsView_reducer_initialState, action) => (0,immer_esm["default"])(state, (draftState) => {
