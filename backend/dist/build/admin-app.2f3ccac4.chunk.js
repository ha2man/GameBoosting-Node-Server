...
const PrivateRoute = (_a) => {
  ...
  return /* @__PURE__ */ react.createElement(
    ...
    {
      path,
      render: (props) => build.auth.getToken() !== null ? /* @__PURE__ */ react.createElement(Component, __spreadValues(__spreadValues({}, rest), props)) : /* @__PURE__ */ react.createElement(
...
const AuthenticatedApp = (0,react.lazy)(
  () => Promise.all(/* import() | Admin-authenticatedApp */[__webpack_require__.e(982), __webpack_require__.e(2172), __webpack_require__.e(801)]).then(__webpack_require__.bind(__webpack_require__, 94369))
);
function App() {
  const toggleNotification = (0,build.useNotification)();
  ...
  const { get } = (0,hooks/* useFetchClient */.kY)();
  ...
  (0,react.useEffect)(() => {
    const getData = () => App_async(this, null, function* () {
      try {
        ...
        const deviceId2 = yield unique_identifier();
        if (uuid2) {
          const {
            data: { data: properties }
          } = yield get(`/admin/telemetry-properties`, {
            validateStatus: (status) => status < 500
          });
          setTelemetryProperties(properties);
          try {
            yield fetch("https://analytics.strapi.io/api/v2/track", {
              method: "POST",
              body: JSON.stringify({
                ...
                groupProperties: __spreadProps(App_spreadValues({}, properties), { projectId: uuid2 })
              }),
              headers: {
  ...
  return /* @__PURE__ */ react.createElement(react.Suspense, { fallback: /* @__PURE__ */ react.createElement(build.LoadingIndicatorPage, null) }, /* @__PURE__ */ react.createElement(SkipToContent/* SkipToContent */.z, null, formatMessage({ id: "skipToContent" })), /* @__PURE__ */ react.createElement(build.TrackingProvider, { value: trackingInfo }, /* @__PURE__ */ react.createElement(react_router_dom_min.Switch, null, authRoutes, /* @__PURE__ */ react.createElement(
    ...
    {
      path: "/auth/:authType",
      render: (routerProps) => /* @__PURE__ */ react.createElement(pages_AuthPage, __spreadProps(App_spreadValues({}, routerProps), { setHasAdmin, hasAdmin })),
      exact: true
    }
...
const Blocker = ({ displayedIcon, description, title, isOpen }) => {
  ...
  if (isOpen) {
    return react_dom.createPortal(
      /* @__PURE__ */ react.createElement(Overlay, null, /* @__PURE__ */ react.createElement(Content, { spacing: 6 }, /* @__PURE__ */ react.createElement(Stack/* Stack */.K, { spacing: 2 }, /* @__PURE__ */ react.createElement(Flex/* Flex */.k, { justifyContent: "center" }, /* @__PURE__ */ react.createElement(Typography/* Typography */.Z, { as: "h1", variant: "alpha" }, formatMessage(title))), /* @__PURE__ */ react.createElement(Flex/* Flex */.k, { justifyContent: "center" }, /* @__PURE__ */ react.createElement(Typography/* Typography */.Z, { as: "h2", textColor: "neutral600", fontSize: 4, fontWeight: "regular" }, formatMessage(description)))), /* @__PURE__ */ react.createElement(Flex/* Flex */.k, { justifyContent: "center" }, displayedIcon === "reload" && /* @__PURE__ */ react.createElement(IconBox, { padding: 6, background: "primary100", borderColor: "primary200" }, /* @__PURE__ */ react.createElement(LoaderReload, { width: (0,build.pxToRem)(36), height: (0,build.pxToRem)(36) })), displayedIcon === "time" && /* @__PURE__ */ react.createElement(IconBox, { padding: 6, background: "primary100", borderColor: "primary200" }, /* @__PURE__ */ react.createElement(Clock["default"], { width: (0,build.pxToRem)(40), height: (0,build.pxToRem)(40) }))), /* @__PURE__ */ react.createElement(Flex/* Flex */.k, { justifyContent: "center" }, /* @__PURE__ */ react.createElement(Box/* Box */.x, { paddingTop: 2 }, /* @__PURE__ */ react.createElement(Link/* Link */.r, { href: "https://docs.strapi.io", isExternal: true }, formatMessage({
...
const notificationReducer = (state = Notifications_reducer_initialState, action) => (0,immer_esm["default"])(state, (draftState) => {
  switch (action.type) {
...
/* harmony import */ var _hooks__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(61931);
...
const Logo = () => {
  ...
  return /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(Img, { src: auth.default, "aria-hidden": true, alt: "" });
};
...
__webpack_require__.d(__webpack_exports__, {
  ...
  "kY": () => (/* reexport */ hooks_useFetchClient),
...
const useSettingsMenu_reducer_reducer = (state, action) => (0,immer_esm["default"])(state, (draftState) => {
  switch (action.type) {
...
var axios = __webpack_require__(9669);
var axios_default = /*#__PURE__*/__webpack_require__.n(axios);
;// CONCATENATED MODULE: ./.cache/admin/src/utils/fetchClient.js
var fetchClient_async = (__this, __arguments, generator) => {
  return new Promise((resolve, reject) => {
    var fulfilled = (value) => {
      try {
        step(generator.next(value));
...
const reqInterceptor = (config) => fetchClient_async(void 0, null, function* () {
  config.headers = {
...
/* harmony default export */ const utils_fetchClient = (fetchClient({ baseURL: "" }));

;// CONCATENATED MODULE: ./.cache/admin/src/utils/getFetchClient.js
var getFetchClient_defProp = Object.defineProperty;
var getFetchClient_getOwnPropSymbols = Object.getOwnPropertySymbols;
var getFetchClient_hasOwnProp = Object.prototype.hasOwnProperty;
var getFetchClient_propIsEnum = Object.prototype.propertyIsEnumerable;
var getFetchClient_defNormalProp = (obj, key, value) => key in obj ? getFetchClient_defProp(obj, key, { enumerable: true, configurable: true, writable: true, value }) : obj[key] = value;
var getFetchClient_spreadValues = (a, b) => {
  for (var prop in b || (b = {}))
    if (getFetchClient_hasOwnProp.call(b, prop))
      getFetchClient_defNormalProp(a, prop, b[prop]);
  if (getFetchClient_getOwnPropSymbols)
    for (var prop of getFetchClient_getOwnPropSymbols(b)) {
      if (getFetchClient_propIsEnum.call(b, prop))
        getFetchClient_defNormalProp(a, prop, b[prop]);
    }
  return a;
};
...
const getFetchClient = (defaultOptions = {}) => {
  return {
    get: (url, config) => utils_fetchClient.get(url, getFetchClient_spreadValues(getFetchClient_spreadValues({}, defaultOptions), config)),
    put: (url, data, config) => utils_fetchClient.put(url, data, getFetchClient_spreadValues(getFetchClient_spreadValues({}, defaultOptions), config)),
    post: (url, data, config) => utils_fetchClient.post(url, data, getFetchClient_spreadValues(getFetchClient_spreadValues({}, defaultOptions), config)),
    del: (url, config) => utils_fetchClient["delete"](url, getFetchClient_spreadValues(getFetchClient_spreadValues({}, defaultOptions), config))
  };
};

;// CONCATENATED MODULE: ./.cache/admin/src/hooks/useFetchClient/index.js
...
/* harmony default export */ const hooks_useFetchClient = (useFetchClient);
...
/* harmony import */ var _strapi_design_system_Box__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(35961);
...
/* harmony import */ var _strapi_design_system_Flex__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(46273);
...
/* harmony import */ var _strapi_design_system_Typography__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(72735);
...
/* harmony import */ var styled_components__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(27821);
...
var uniqueAdminHash_async = (__this, __arguments, generator) => {
  return new Promise((resolve, reject) => {
    var fulfilled = (value) => {
      try {
        step(generator.next(value));
...
const utils = {
  ...
  digestMessage(message) {
    return uniqueAdminHash_async(this, null, function* () {
...
function hashAdminUserEmail(payload) {
  return uniqueAdminHash_async(this, null, function* () {
    if (!payload) {
      return null;
    }
    try {
      return yield utils.digestMessage(payload.email);
    } catch (error) {
      return null;
    }
  });
...
/* harmony import */ var styled_components__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(27821);
/* harmony import */ var _strapi_design_system_Box__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(35961);
/* harmony import */ var _strapi_design_system_Flex__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(46273);
...
const Login = (loginProps) => {
  ...
  return /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_admin_src_layouts_UnauthenticatedLayout__WEBPACK_IMPORTED_MODULE_3__/* ["default"] */ .ZP, null, /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_admin_src_pages_AuthPage_components_Login_BaseLogin__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .Z, __spreadValues({}, loginProps), /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_strapi_design_system_Box__WEBPACK_IMPORTED_MODULE_8__/* .Box */ .x, { paddingTop: 7 }, /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_strapi_design_system_Stack__WEBPACK_IMPORTED_MODULE_9__/* .Stack */ .K, { spacing: 7 }, /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_strapi_design_system_Flex__WEBPACK_IMPORTED_MODULE_10__/* .Flex */ .k, null, /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(DividerFull, null), /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_strapi_design_system_Box__WEBPACK_IMPORTED_MODULE_8__/* .Box */ .x, { paddingLeft: 3, paddingRight: 3 }, /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_strapi_design_system_Typography__WEBPACK_IMPORTED_MODULE_11__/* .Typography */ .Z, { variant: "sigma", textColor: "neutral600" }, formatMessage({ id: "Auth.login.sso.divider" }))), /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(DividerFull, null)), /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_Providers_SSOProviders__WEBPACK_IMPORTED_MODULE_4__/* ["default"] */ .Z, { providers, displayAllProviders: false })))));
};
Login.defaultProps = {
  onSubmit: (e) => e.preventDefault(),
  requestError: null
...
/* harmony import */ var _strapi_design_system_Flex__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(46273);
/* harmony import */ var _strapi_design_system_Typography__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(72735);
